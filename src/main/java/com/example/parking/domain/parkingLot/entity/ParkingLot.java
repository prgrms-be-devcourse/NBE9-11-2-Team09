...
public class ParkingLot {
    ...
    private static final LocalTime DEFAULT_OPERATION_START_TIME = LocalTime.of(9, 0);   // 09:00
    private static final LocalTime DEFAULT_OPERATION_END_TIME = LocalTime.of(18, 0);   // 18:00
